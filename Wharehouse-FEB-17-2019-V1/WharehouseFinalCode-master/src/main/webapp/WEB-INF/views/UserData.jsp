						...
						<table class="table table-border table-hover ">
							...
							<c:forEach items="${user}" var="user">
								<tr>
									...
									<td><a href="view?userId=${user.userId}"><img
											src="../resources/images/view.png" height="40" width="40">
									</a></td>
									<td><a href="editPage?userId=${user.userId}"><img
											src="../resources/images/edit.png" height="40" width="40">
									</a></td>
									<td><a href="delete?userId=${user.userId}"><img
											src="../resources/images/delete.png" height="40" width="40">
									</a></td>
									<td><a href="excelExport?userId=${user.userId}"><img
											src="../resources/images/excel.png" height="40" width="40">
									</a></td>
									<td><a href="pdfExport?userId=${user.userId}"><img
